...
import { User, Shield, Book, CheckSquare, Building, Users as UsersIcon, BookOpenCheck } from 'lucide-react';
...
import { BulkRegisterStudents } from '@/components/super-admin/BulkRegisterStudents';
import { RegisterSingleStudent } from '@/components/super-admin/RegisterSingleStudent';
    ...
    return (
        <div className="container py-8">
            ...
            <Accordion type="multiple" defaultValue={['students', 'faculties']} className="w-full space-y-4">
                ...
                <AccordionItem value="register-single">
                    <AccordionTrigger className="text-xl font-semibold p-4 bg-muted/50 rounded-md">
                        <div className="flex items-center gap-2">
                    ...
                    <AccordionContent className="p-4">
                        <RegisterSingleStudent onRegistrationComplete={handleUserRegistered} />
                    </AccordionContent>
                </AccordionItem>

                <AccordionItem value="bulk-register">
                    <AccordionTrigger className="text-xl font-semibold p-4 bg-muted/50 rounded-md">
                        <div className="flex items-center gap-2">
                            <UsersIcon className="h-6 w-6" />
                    ...
                    <AccordionContent className="p-4">
                        <BulkRegisterStudents onRegistrationComplete={handleUserRegistered} />
                    </AccordionContent>
                </AccordionItem>
